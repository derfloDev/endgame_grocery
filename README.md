...
- The backend tracks per-list autocomplete history from completed and deleted items, including items completed through the external v1 API, exposes ranked typo-tolerant suggestions, and provides per-list recently used history endpoints.
