...
- Shared members can remove their own access with `DELETE /api/lists/:id/leave`; owners cannot leave their own lists, and the owner receives an email when a member leaves.
