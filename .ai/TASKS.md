...
| T-002 | In-app Buy Me a Coffee link in InfoSheet: add donate section to `InfoSheet.jsx`, CSS rule, and test assertion | ready_for_implement | Info & Settings sheet renders a BMC link to `https://www.buymeacoffee.com/derflodev`; `InfoSheet.test.jsx` passes; lint and build pass | n/a | implement |
