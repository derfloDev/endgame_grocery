...
| T-004 | Frontend: expand icon registry with 45 new food/health/household icons from Tabler and Lucide; update iconDatabase.js entries | ready_for_implement | All 45 new icons importable and visible in the icon browser; iconDatabase.js updated entries use new specific icons; `npm run build` passes with no missing-export errors; `npm test` passes | n/a | implement |
