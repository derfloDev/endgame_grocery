...
| T-005 | Entry Management | ready_for_implement | CRUD endpoints enforce membership; ListDetailPage shows open and done sections; Enter-key input refocuses immediately; toggling status moves entry to correct section | n/a | implement |
| T-006 | List Sharing | ready_for_implement | Owner can share by email (404/409 handled); recipient sees list in overview; owner can revoke; shared badge visible in overview | n/a | implement |
