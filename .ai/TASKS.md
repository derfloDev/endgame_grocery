...
| T-003 | Show logged-in user at top of Info & Settings sheet | done | `display_name` and `email` visible above the logout button immediately after login and after page reload | `npm run lint`; `npm run build`; `npm test` | none |
