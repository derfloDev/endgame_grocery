...
| T-002 | Frontend: new api/history.js; new RecentlyUsedSection component; ListDetailPage removes Done section, adds Recently Used section with one-tap add + dismiss; index.css styles | ready_for_implement | (6) Recently Used section visible below Open Items when history non-empty. (7) Tapping chip adds item and removes chip from panel. (8) Dismiss button removes chip and calls DELETE /history. (9) Done section absent. (10) Open items never appear in panel. | n/a | implement |
