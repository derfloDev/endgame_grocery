...
| T-003 | Add single divider line above Logout button | ready_for_implement | (1) Thin border-top divider visible above Logout button. (2) No other visual changes. (3) lint + build + test green. | n/a | implement |
