...
| T-002 | Discard non-retriable 4xx sync failures: detect 4xx in drainQueue, expose failedMutationId + discardFailedMutation in context, render Discard button in OfflineBanner, add i18n keys | ready_for_implement | 4xx sets syncError + failedMutationId; 5xx keeps retry behavior; Discard button removes mutation + clears error + re-drains; both locales have offline.discard key | n/a | implement |
