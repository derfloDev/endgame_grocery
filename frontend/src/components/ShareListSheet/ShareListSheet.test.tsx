...
const cssSource = readFileSync(path.resolve(import.meta.dirname, "./ShareListSheet.module.css"), "utf8");
...
describe("ShareListSheet", () => {
  ...
  it("renders invite feedback inside a dedicated spacing wrapper", () => {
    ...
    expect(screen.getByTestId("share-list-sheet-feedback")).toBeTruthy();
