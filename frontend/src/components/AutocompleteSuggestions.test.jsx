...
describe("AutocompleteSuggestions", () => {
  ...
  it("renders a suggestion without an icon and keeps the chip touch target at least 44px tall", () => {
    ...
    expect(cssSource).toMatch(/\.autocomplete-chip\s*\{[^}]*min-height:\s*44px;/s);
  });
});
